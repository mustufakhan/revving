...
import NotionalInvoiceTable from './NotionalInvoiceTable';
...
const NotionalInvoiceSection: React.FC<IProps> = ({
  dispatch,
  dataSource,
  customerData,
  transNotionalInvoice,
  ...
  const [orderBy, setOrderBy] = useState<string>('-end_date');
  ...
  const handleStatusType = (event: React.ChangeEvent<{ value: unknown }>) => {
  ...
  }, [getNotionalTransactionalInvoice?.data]);
      ...
      <MainContentWrapper>
        <Breadcumb
          breadCrumb={{
            ...
            data: ['Transactional Invoices', 'Transactional Invoices']
          }}
        />
        <ContentBoxWrapper>
            ...
            <Grid item xs={12} sm={4}>
              <StyledFormControl variant='outlined'>
                ...
                >
                  ...
                  <MenuItem key='no-value-status' value='rejected'>
                    Rejected
                  </MenuItem>
                  <MenuItem key='no-value-status' value='success'>
                    Sent
                  </MenuItem>
                  <MenuItem key='no-value-status' value='failed'>
                    Failed
                  </MenuItem>
                </Select>
              </StyledFormControl>
          ...
          <Grid container spacing={3}>
            <Grid item xs={12} sm={12}>
              {isLoading ? (
                ...
                <NotionalInvoiceTable
                  transNotionalInvoice={transNotionalInvoice}
...
const mapStateToProps = (state: any) => ({
  ...
  transNotionalInvoice: state.transNotionalInvoice.data,
...
export default connect(mapStateToProps)(NotionalInvoiceSection);
