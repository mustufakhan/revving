...
const RejectedInvoiceTable: React.FC<IProps> = ({
  dispatch,
  rejectedInvoiceTable,
  customerData,
  revenueSourceMasterList
      ...
      <MainContentWrapper>
        <Breadcumb
          breadCrumb={{
            ...
            data: ['Month-End Invoices', 'Unmatched Collateral Invoices']
          }}
        />
        <ContentBoxWrapper>
            ...
            <Grid item xs={12} sm={4}>
              <StyledFormControl variant='outlined'>
                ...
                >
                  ...
                  <MenuItem key='no-value-ds' value='Pending'>
                    Pending
                  </MenuItem>
          ...
          <Grid container spacing={3}>
            <Grid item xs={12} sm={12}>
              {isLoading ? (
                ...
                <DataTable
                  rejectedInvoiceTable={rejectedInvoiceTable}
...
const mapStateToProps = (state: any) => ({
  rejectedInvoiceTable: state.rejectedInvoiceTable.data,
  customerData: state.customerList.data,
  revenueSourceMasterList: state.revenueSourceMasterList.data
});

export default connect(mapStateToProps)(RejectedInvoiceTable);
